...
running command...
$ cli (--version)
cli/0.0.0 win32-x64 node-v22.12.0
$ cli --help [COMMAND]
USAGE
  $ cli COMMAND
...
...
_See code: [src/commands/hello/index.ts](https://github.com/cli/cli/blob/v0.0.0/src/commands/hello/index.ts)_
...
_See code: [src/commands/hello/world.ts](https://github.com/cli/cli/blob/v0.0.0/src/commands/hello/world.ts)_
